...
exports.simulate = function (temp) {
    var
        ...
        m = 18.0,                                             // Weigh of the water (kg)
        Ta = 25,                                              // Temperature of the environment (your room, etc.) (°C)
        Rth = 16, // original was 0.024,                       // Thermal conductivity, total thermal resistance between
    // the water and the surrounding ambient (°C/W)
    // List: http://www.engineeringtoolbox.com/thermal-conductivity-d_429.html
        Pmax = 1973,

        outFile = fs.createWriteStream('./output.csv'),
        StopTime = 7200,                                      // Total time of the simulation (s)
        deltaT,                                               // Delta temperature
        T0 = 25,                                              // Start temperature of the water (°C)
